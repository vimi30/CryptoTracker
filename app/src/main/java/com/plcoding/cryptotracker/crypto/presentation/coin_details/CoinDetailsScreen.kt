...
import com.plcoding.cryptotracker.crypto.presentation.coin_details.component.InfoCard
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            FlowRow(
                ...
                val infoContentColor = if (isPositive) {
            ...
            AnimatedVisibility(
                ...
                var totalChatWidth by remember {
                    mutableFloatStateOf(0f)
                }

                val amountOfVisibleDataPoints = if (labelWidth > 0) {
                    ((totalChatWidth - 2.5 * labelWidth) / labelWidth).toInt()
                }else{
                    0
                }
                ...
                LineChart(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .aspectRatio(16 / 9f)
                        .onSizeChanged { totalChatWidth = it.width.toFloat() },
